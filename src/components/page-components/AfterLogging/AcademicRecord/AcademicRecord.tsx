						...
						<div className="sm:border-r-2 border-dashed border-black/50 p-6 flex flex-col justify-center max-sm:border-b-2">
							...
							<Link href="/student-record">
								<Button
									...
									className="py-[14px] md:min-w-[164px] md:min-h-[66px] text-lg"
								/>
							</Link>
						</div>
				...
				<div className="container">
					...
					<div className="flex flex-wrap gap-3 justify-between items-center mt-20 lg:mt-[294px] pb-5 border-b-2 border-black">
						<div className="disc-title">
							학생부교과 성적{" "}
							<sub className="text-black/50">(국영수사과한)</sub>
						</div>
						<button
							className="text-lg md:text-2xl underline cursor-pointer"
							type="button"
					...
					/>
					<div className="text-sm text-black/50 mt-4">
					...
					<div className="table">
						<tbody>
							<tr>
								<th className="w-[100px]">서류 분석</th>
								<td className="w-[600px]">
									{/* Radio Group */}
									<div className="lg:px-5">
										<RadioGroup
											defaultValue="출결"
											className="flex flex-wrap gap-y-2 gap-x-10 md:gap-x-20 lg:gap-x-[100px]"
										>
											<label className="flex gap-2 items-center">
												<RadioGroupItem
													value="출결"
					...
					<div className="text-sm text-black/50 mt-4">
						※ 미제공 시 교과 외 평가 기준(출결/봉사/서류)을 적용하는
						전형에서 출결과 봉사는 만점 처리하며, 서류 평가를 제외하고
						학생부교과 성적으로만 분석합니다.
					</div>
