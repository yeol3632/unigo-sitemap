				...
				<div className="container">
					...
					<div className="bg-[#F8F8F8] px-6 pb-[22px]">
						...
						<h5 className="text-2xl md:text-[32px] md:leading-[1.46] pb-9 mt-3 text-center font-semibold">
							<span className="font-bold">2025학년도를</span>
							기준으로 분석이 진행됩니다.
						</h5>
					...
					<div className="flex flex-wrap gap-3 justify-between items-center mt-20 lg:mt-[294px] pb-5 border-b-2 border-black">
						<div className="disc-title">
							학생부교과 성적{" "}
							<sub className="text-[#6A6A6A] text-[60%]">
								(국영수사과한)
							</sub>
						</div>
						<button
							...
							<tbody>
								<tr>
									...
									<td>
										<Link
											href="/sign-up"
											className="text-[#08080C] inline-block py-1 px-4 rounded-[10px] border border-black/50"
										>
											등록
										</Link>
									</td>
					...
					<div className="mt-4 text-sm text-[#08080C]/50">
						※ 입력하지 않은 학기 성적은 마지막 학기 성적으로 대체되어
						분석됩니다. (3학년 2학기 제외)
					</div>
					{/*  */}
					<div className="flex flex-wrap gap-3 justify-between items-center mt-20 lg:mt-[294px] pb-5 border-b-2 border-black">
						<div className="disc-title">생기부</div>
						<button
							className="text-lg md:text-2xl underline cursor-pointer"
							type="button"
						>
					...
					<div>
						<table className="table">
							<thead>
								<th className="md:px-1">서류 분석</th>
								<td>
									<RadioGroup
										defaultValue="제공"
										className="flex flex-wrap gap-3 lg:px-8 lg:gap-x-12"
									>
										<label className="flex gap-2 items-center">
											<RadioGroupItem
												value="제공"
					...
					<div className="flex flex-wrap gap-5 lg:gap-9 justify-center mt-20 lg:mt-[159px]">
						<Button
							text="목표 대학 선택"
							variant="outlineFilled"
							className="py-[14px] text-xl md:text-[28px] md:max-w-[326px] md:min-h-[94px] w-full"
						/>
